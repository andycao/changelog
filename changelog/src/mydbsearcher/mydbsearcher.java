...
public class mydbsearcher extends recordUpdater{
	...
	public List<theProject> getAllProjects(){
		session = getSession();
		//select all projects
		Query query = session.createQuery("from theProject order by projectId DESC");
	...
	public List<Program> getAllPrograms(){
		session = getSession();
		Query query = session.createQuery("from Program order by programId DESC");
	...
	public List<Change> allChanges(){
		session = getSession();
		Query query = session.createQuery("from Change order by changeId DESC");
	...
	public List<Change> getChangesByUserID(int userid){
		session = getSession();
		Query query = session.createQuery("from Change where userId =:user order by changeId DESC");
