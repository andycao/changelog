...
<div id="header">
	...
	当前时间：<label id="timelabel"></label> 
	<a href="/changelog/show/welcomemain.jsp" target="welcomemain">首页</a>
	<a id="logout" href="/changelog/logout.action" target=_parent>登出</a></p>
	<hr>
</div>
</body>
</html>