...
<div id="main">
	<div class="show">
		...
		<p>开始时间：<s:date name="searchResult.startTime" format="yyyy-MM-dd"/></p>
		<p>最后更改时间：<s:date name="searchResult.lastChangeTime" format="yyyy-MM-dd"/></p>
		...
		<p><a href="#" onclick="show_confirm('/changelog/func/removeProject.action?projectId=<s:property value="searchResult.projectId" />')">删除该项目</a></p>
