...
<s:set id="pojname" name="pojname" value="#request.projectName"/>
<s:set id="pojstime" name="pojstime" value="#request.projectStartTime"></s:set>
<s:set id="pojdetail" name="pojdetail" value="#request.projectDetail"></s:set>
