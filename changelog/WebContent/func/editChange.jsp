...
<h3>编辑更改记录</h3>
<s:set id="chnid" name="chnid" value="#request.changeId"/>
<s:set id="chnfile" name="chnfile" value="#request.changeFile"/>
<s:set id="chndate" name="chndate" value="#request.changeDate"/>
<s:set id="chndetail" name="chndetail" value="#request.changeDetail"></s:set>
