...
<h3>修改工程</h3>
<s:set id="pomid" value="#request.programId"/>
<s:set id="pomname" value="#request.programName"/>
<s:set id="pomstime" value="#request.programStartTime"></s:set>
<s:set id="pomDetail" value="#request.programDetail"></s:set>
