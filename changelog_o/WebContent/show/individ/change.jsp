...
<div id="main">
	<div class="show">
		...
		<tr>
		<td><label>更改日期：</label></td><td><s:property value="changeResult.changeDate" /></td>
		</tr>
		<tr>
		...
		<%if(tit.equals("编辑")){ %>
			<p><a href="/changelog/func/removeChange.action?changeId=<s:property value='changeResult.changeId' />">删除该记录</a></p>
		<%} %>
		<%if(tit.equals("实施")){ %>
			<p><a href="/changelog/func/removeSelfChange.action?changeId=<s:property value='changeResult.changeId' />&
			userId=<%= uid%>">删除该记录</a></p>
		<%} %>
